...
export const useManageMangaLibraryState = (
    manga: Pick<MangaType, 'id' | 'title' | 'sourceId'> & Partial<Pick<MangaType, 'inLibrary'>>,
    ...
    const removeFromLibrary = useCallback(async () => {
        ...
        if (manga.sourceId) {
            requestManager.updateSourceMangaLibraryStateInCache(manga.sourceId, manga.id, false);
        }
        setIsInLibrary(false);
    }, [manga.id, manga.sourceId, confirmRemoval]);
