...
const NAVIGATION_BAR_BASE_ITEMS = [
    {
        ...
        title: 'Video' as NavbarItem['title'],
    ...
    {
        path: AppRoutes.novel.path as RestrictedNavBarItem<'both'>['path'],
        title: 'Novels' as NavbarItem['title'],
    ...
    {
        path: AppRoutes.srs.path as RestrictedNavBarItem<'both'>['path'],
        title: 'SRS' as NavbarItem['title'],
        SelectedIconComponent: SchoolIcon,
        IconComponent: SchoolOutlinedIcon,
        show: 'both',
        moreGroup: NavBarItemMoreGroup.GENERAL,
    },
    {
