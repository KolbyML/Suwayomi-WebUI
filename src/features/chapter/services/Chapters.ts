...
export class Chapters {
        ...
        return Chapters.executeAction(
            ...
            () =>
                requestManager.updateChapters(Chapters.getIds(chapters), {
                    ...
                    lastPageRead: 0,
                    chapterIdsToDelete,
                    trackProgressMangaId: wasManuallyMarkedAsRead ? trackProgressMangaId : undefined,
                }).response,
            disableConfirmation,
        );
    }
    ...
    static async markAsUnread(
        ...
        return Chapters.executeAction(
            ...
            chapterIds.length,
            () =>
                requestManager.updateChapters(chapterIds, {
                    isRead: false,
                    lastPageRead: 0,
    ...
    static async performAction<Action extends ChapterAction>(
        ...
        switch (action) {
            ...
            case 'mark_as_unread':
                return Chapters.markAsUnread(chapterIds, trackProgressMangaId);
            case 'bookmark':
