...
type TChapter = ChapterIdInfo &
    ...
    ChapterNumberInfo &
    ChapterScanlatorInfo &
    Pick<ChapterType, 'name' | 'sourceOrder' | 'uploadDate' | 'lastPageRead' | 'pageCount'>;
...
export const ChapterCard = memo((props: IProps) => {
    ...
    const progressLabel =
        !chapter.isRead && chapter.lastPageRead > 0
            ? `Page ${chapter.lastPageRead + 1}${chapter.pageCount > 0 ? `/${chapter.pageCount}` : ''}`
            : '';
    const ternaryTextParts = [
                        ...
                        >
                            <ListCardContent>
                                <ChapterCardMetadata
                                    ...
                                    ternaryText={ternaryTextParts.join(' • ')}
                                    infoIcons={
