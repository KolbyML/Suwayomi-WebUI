...
import { getAnimeThumbnailUrl, toggleAnimeLibraryState } from '@/features/anime/services/AnimeLibrary.ts';
...
export const AnimeGridCard = ({
    ...
    const imagePriority = mode === 'source' ? Priority.NORMAL : Priority.LOW;
    const fetchPriority = mode === 'source' ? 'auto' : 'low';
    const backendPriority = mode === 'source' ? 'normal' : 'low';
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <SpinnerImage
                                        alt={anime.title}
                                        src={getAnimeThumbnailUrl(anime)}
