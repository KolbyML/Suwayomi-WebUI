...
import { getAnimeThumbnailUrl } from '@/features/anime/services/AnimeLibrary.ts';
...
import { useManatanAnimeDescriptionCollapsed } from '@/Manatan/anime/AnimePrivateAdapters.ts';
...
const AnimeDescriptionGenre = ({ description, genres }: { description?: string | null; genres: string[] }) => {
    ...
    const [isCollapsed, setIsCollapsed] = useManatanAnimeDescriptionCollapsed();
...
export const AnimeDetailsPanel = ({
    ...
    const { t } = useTranslation();
    const thumbnailSrc = getAnimeThumbnailUrl(anime);
        ...
        <DetailsWrapper>
            <TopContentWrapper url={thumbnailSrc} animeThumbnailBackdrop={mangaThumbnailBackdrop && !!thumbnailSrc}>
                ...
                <AnimeButtonsContainer>
                    ...
                    <TrackAnimeButton anime={anime} onTrackingChanged={onTrackingChanged} />
