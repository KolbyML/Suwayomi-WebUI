...
import {
    MANATAN_LIBRARY_DUPLICATES_ALT_TITLES_META_KEY,
    MANATAN_LIBRARY_DUPLICATES_GRID_LAYOUT_META_KEY,
    useServerMetaState,
...
export const LibraryDuplicates = () => {
    ...
    const [gridLayout, setGridLayout] = useServerMetaState(
        MANATAN_LIBRARY_DUPLICATES_GRID_LAYOUT_META_KEY,
        GridLayout.List,
        { legacyLocalStorageKey: 'libraryDuplicatesGridLayout' },
    );
    const [checkAlternativeTitles, setCheckAlternativeTitles] = useServerMetaState(
        MANATAN_LIBRARY_DUPLICATES_ALT_TITLES_META_KEY,
        false,
        { legacyLocalStorageKey: 'libraryDuplicatesCheckAlternativeTitles' },
    );
