...
import {
    MANATAN_MIGRATE_GRID_LAYOUT_META_KEY,
    useServerMetaState,
...
export const Migrate = () => {
    ...
    const [gridLayout, setGridLayout] = useServerMetaState(MANATAN_MIGRATE_GRID_LAYOUT_META_KEY, GridLayout.List, {
        legacyLocalStorageKey: 'migrateGridLayout',
    });
