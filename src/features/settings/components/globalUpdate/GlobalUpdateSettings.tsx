...
export const GlobalUpdateSettings = ({
    ...
    mangaCategories: CategoriesInclusionSettingProps['categories'];
    animeCategories: CategoriesInclusionSettingProps['categories'];
}) => {
        ...
        >
            ...
            <CategoriesInclusionSetting
                ...
                updateCategory={(category) =>
                    requestManager.updateAnimeCategory(category.id, { includeInUpdate: category.includeInUpdate })
                        .response
                }
            />
            <ListItem>
