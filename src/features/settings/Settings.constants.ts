...
export const SERVER_SETTINGS_METADATA_DEFAULT: MetadataServerSettings = {
    ...
    showAddToLibraryAnimeCategorySelectDialog: true,
    ignoreFilters: false,
    removeMangaFromCategories: false,
    removeAnimeFromCategories: false,
    showTabSize: false,
    ...
    animeExtensionLanguages: ['ja', 'en', 'all'],
    ...
    // navigation
    defaultStartupPage: AppRoutes.library.path(),
    visibleTabs: NAVIGATION_BAR_ITEMS.map((item) => item.path),
