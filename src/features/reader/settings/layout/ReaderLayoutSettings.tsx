            ...
            {isSeriesMode && (
                <>
                    ...
                    <ReaderSettingReadingMode
                        ...
                        setReadingModePreset={({ readingMode, readingDirection }) => {
                            updateSetting('readingMode', readingMode);
                            updateSetting('readingDirection', readingDirection);
                        }}
                        isDefaultable={isDefaultable}
                        onDefault={() => {
                            onDefault?.('readingMode');
                            onDefault?.('readingDirection');
                        }}
                    />
                </>
            )}
