...
export const ReaderDefaultLayoutSettings = ({
    ...
    readingDirection?: IReaderSettingsWithDefaultFlag['readingDirection'];
}) => {
                ...
                <Stack sx={{ pt: 2, px: 2 }}>
                    <ReaderSettingReadingMode
                        ...
                        setReadingModePreset={({
                            ...
                            updateSetting('readingMode', nextReadingMode);
                            updateSetting('readingDirection', nextReadingDirection);
                        }}
                    />
                </Stack>
            )}
