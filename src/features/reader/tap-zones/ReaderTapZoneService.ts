...
export class ReaderTapZoneService {
    ...
    private static invertRect(rect: ReaderTapZoneRect, { vertical, horizontal }: InvertMode): ReaderTapZoneRect {
    ...
    static getRegions(layout: TapZoneLayouts, invertMode: InvertMode): TapZoneRegion[] {
        const regions =
