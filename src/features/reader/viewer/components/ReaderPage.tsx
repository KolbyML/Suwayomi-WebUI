...
import { ReaderOcrOverlay } from '@/Manatan/components/ReaderOcrOverlay';
...
const BaseReaderPage = ({
    ...
    const updateRef = useCallback(
        (element: HTMLImageElement | HTMLDivElement | null) => {
            imageRef.current = element instanceof HTMLImageElement ? element : null;
    ...
    const imageMarginStyling = getImageMarginStyling(doublePage, position);
    const imagePlaceholderStyling = getImagePlaceholderStyling(
        readingMode,
        shouldStretchPage,
        pageScaleMode,
        readerWidth,
    ...
    const readerImageStyling = getReaderImageStyling(
        readingMode,
        shouldStretchPage,
        pageScaleMode,
        doublePage,
    ...
    return (
        <Box
            className="reader-page-image-shell"
            sx={{
                position: 'relative',
                display: 'grid',
                placeItems: 'center',
        ...
        >
            ...
            />
            <ReaderOcrOverlay imgRef={imageRef} src={src} enabled={display && Boolean(shouldLoad)} />
        </Box>
    );
};
