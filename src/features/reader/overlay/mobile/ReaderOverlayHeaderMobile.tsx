...
const OVERLAY_SLIDE_TIMEOUT = { enter: 0, exit: 195 };
...
const BaseReaderOverlayHeaderMobile = ({ isVisible, ref }: MobileHeaderProps & { ref?: Ref<HTMLDivElement> }) => {
    ...
    return (
        <Slide direction="down" in={isVisible} ref={ref} timeout={OVERLAY_SLIDE_TIMEOUT}>
            <Stack
                sx={{
                    flexDirection: 'row',
                    alignItems: 'center',
                    ...
                    {manga && currentChapter ? (
                        <>
                            <CustomTooltip title={title}>
                                <TypographyMaxLines lines={1} component="h1" variant="h5" sx={{ minWidth: 0 }}>
                                    <Link
                            ...
                            <CustomTooltip title={name}>
                                <TypographyMaxLines lines={1} sx={{ minWidth: 0 }}>
                                    {/* FIX 2: Chapter Name */}
                                    <span
                                        className="yomitan-ghost-text"
                                        data-text={name}
