...
import { ProgressBarType, ReaderTransitionPageMode } from '@/features/reader/Reader.types.ts';
...
const BaseStandardReaderProgressBar = ({
    ...
    const { totalPages, transitionPageMode } = useReaderPagesStore((state) => ({
    ...
    const shouldDisableInteractions = transitionPageMode !== ReaderTransitionPageMode.NONE;
                ...
                slotProps={{
                    container: {
                        sx: {
                            ...
                            ...applyStyles(shouldDisableInteractions, {
                                pointerEvents: 'none',
                            }),
                        },
                        onMouseEnter: () => {
