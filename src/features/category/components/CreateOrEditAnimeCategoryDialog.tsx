...
export const CreateOrEditAnimeCategoryDialog = ({
    category,
    onClose,
    onSaved,
}: {
    ...
    const handleDialogSubmit = async () => {
        ...
        if (isEditMode) {
            try {
                await requestManager.updateAnimeCategory(category.id, { name: dialogName, default: dialogDefault })
                    .response;
                onSaved?.();
            } catch (e) {
        ...
        try {
            await requestManager.createAnimeCategory({ name: dialogName, default: dialogDefault }).response;
            onSaved?.();
        } catch (e) {
        ...
        <Dialog open onClose={onClose}>
            ...
            <DialogContent>
                ...
                <FormControlLabel
                    ...
                    label="Default category when adding new anime to the library"
                />
            </DialogContent>
            <DialogActions>
