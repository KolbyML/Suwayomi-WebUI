...
export type CategoriesInclusionSettingProps = {
    ...
    dialogText?: string;
    title?: string;
    updateCategory?: (category: CategoryType) => Promise<any>;
};
...
export const CategoriesInclusionSetting = ({
    ...
    const updateCategoryByRequest = (category: CategoryType) =>
    ...
    const updateCategories = async () => {
        ...
        try {
            await Promise.all(
                categoriesToUpdate.map((category) => (updateCategory ?? updateCategoryByRequest)(category)),
            );
    ...
    return (
        <>
            <ListItemButton onClick={() => setIsDialogOpen(true)}>
                <ListItemText
                    primary={title ?? t('category.title.category_other')}
                    secondary={
                        <>
                            <span>
            ...
            <Dialog open={isDialogOpen} onClose={closeDialog}>
                <DialogTitle>{title ?? t('category.title.category_other')}</DialogTitle>
                <DialogContent>
