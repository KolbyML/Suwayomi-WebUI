...
export const timeFormatter = new Intl.DateTimeFormat(defaultLocale, { hour: '2-digit', minute: '2-digit' });
export const dateFormatter = new Intl.DateTimeFormat(defaultLocale, {
    year: 'numeric',
    month: '2-digit',
    day: '2-digit',
});
export const dateTimeFormatter = new Intl.DateTimeFormat(defaultLocale, {
    year: 'numeric',
    month: '2-digit',
    day: '2-digit',
    hour: '2-digit',
