...
export const AppRoutes = {
    ...
    settings: {
        ...
        childRoutes: {
            ...
            animeCategories: {
                match: 'anime-categories',
                path: '/settings/anime-categories',
            },
            novelCategories: {
                match: 'novel-categories',
                path: '/settings/novel-categories',
            },
            reader: {
                match: 'reader',
            ...
            library: {
                ...
                childRoutes: {
                    ...
                    animeDuplicates: {
                        match: 'anime-duplicates',
                        path: '/settings/library/anime-duplicates',
                    },
                },
            },
            download: {
    ...
    animeSources: {
        ...
        childRoutes: {
            searchAll: {
                match: 'all/search',
                path: (query?: string | null | undefined) => UrlUtil.addQueryParam('/anime-sources/all/search', query),
            },
            browse: {
                match: ':sourceId',
    ...
    anime: {
        ...
        childRoutes: {
            local: {
                match: 'local',
                path: (token?: string | null) =>
                    token ? `/anime/local?token=${encodeURIComponent(token)}` : '/anime/local',
            },
            details: {
                match: ':id',
    ...
    novel: {
        ...
        childRoutes: {
            reader: {
                match: ':id/read',
                path: (id: string) => `/novel/${encodeURIComponent(id)}/read`,
            },
        },
    },
