...
type MutableListSettingProps = Pick<TextSettingProps, 'settingName' | 'placeholder'> & {
    ...
    pickItemButtonTitle?: string;
    onPickItem?: () => Promise<string | null | undefined> | string | null | undefined;
        ...
        <>
            ...
            {isAddItemDialogOpen && (
                <TextSettingDialog
                    ...
                    onPickValue={onPickItem}
                    pickValueButtonTitle={pickItemButtonTitle}
                />
            )}
        </>
    );
