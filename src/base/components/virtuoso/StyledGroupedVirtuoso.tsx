...
export const StyledGroupedVirtuoso = ({
    ...
    const stickyHeaderOffset = useWindowScroll ? appBarHeight + heightToSubtract : 0;

    const TopItemList = useMemo(() => StickyVirtuosoHeaderWithOffset(stickyHeaderOffset), [stickyHeaderOffset]);
