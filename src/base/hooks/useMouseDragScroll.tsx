...
const shouldIgnoreMouseDragScrollTarget = (target: EventTarget | null) => {
    ...
    return (
        ...
        Boolean(
            element.closest(
                '.gemini-ocr-text-box, .ocr-modal, .ocr-modal-overlay, button, a, input, textarea, select, [contenteditable="true"]',
            ),
        )
    );
};
...
export const useMouseDragScroll = (
    ...
    useEffect(() => {
        ...
        const handleMouseDown = (e: MouseEvent) => {
            ...
            if (!isLeftMouseButton || shouldIgnoreMouseDragScrollTarget(e.target)) {
                return;
            }
